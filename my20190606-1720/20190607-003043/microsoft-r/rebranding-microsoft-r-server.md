...
ms.topic: overview
ms.prod: mlserver
ms.openlocfilehash: 42e778437c3024b9f3316ccbc57cd1a57820da45
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="microsoft-r-server-is-now-microsoft-machine-learning-server"></a>Microsoft R Server is now Microsoft Machine Learning Server
...
## <a name="building-on-our-commitment-to-r"></a>Building on our commitment to R
...
## <a name="upgrade-to-machine-learning-server"></a>Upgrade to Machine Learning Server
...
## <a name="download-prior-r-server-releases"></a>Download prior R Server releases
...
## <a name="get-support-for-r-server"></a>Get support for R Server
...
## <a name="the-future-of-microsoft-r-client"></a>The future of Microsoft R Client
