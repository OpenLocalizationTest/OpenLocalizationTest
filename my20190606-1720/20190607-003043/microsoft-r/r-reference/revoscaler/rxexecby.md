...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 6af348ab7ae553e4a9dfccaebc2d5efee5c809fb
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="rxexecby-partition-data-by-key-values-and-execute-user-function-on-each-partition"></a>rxExecBy: Partition Data by Key Values and Execute User Function on Each Partition 
...
Currently supported in `local`, `localpar`, [RxInSqlServer](RxInSqlServer.md) and [RxSpark](RxSpark.md) compute contexts.
...
[rxExecByPartition](rxExecByPartition.md), [rxImport](rxImport.md), [rxDataStep](rxDataStep.md), [RxTextData](RxTextData.md), [RxXdfData](RxXdfData.md), [RxHiveData](RxSparkData.md), [RxSqlServerData](RxSqlServerData.md)
