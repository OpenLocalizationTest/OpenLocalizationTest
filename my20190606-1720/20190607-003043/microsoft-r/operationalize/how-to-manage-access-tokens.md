...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 5279d64b5f9dd0766044f171fef45383be021598
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="manage-access-tokens-for-api-requests"></a>Manage access tokens for API requests
...
## <a name="create-tokens"></a>Create tokens
...
#### <a name="example-token-creation-request"></a>Example: Token creation request 
...
## <a name="token-lifecycle"></a>Token Lifecycle
...
## <a name="use-tokens"></a>Use tokens
...
## <a name="renew-tokens"></a>Renew tokens
...
#### <a name="example-refresh-accesstoken"></a>Example: Refresh access_token
...
## <a name="revoke-refresh-tokens"></a>Revoke refresh tokens
...
#### <a name="example-revoke-token"></a>Example: Revoke token
