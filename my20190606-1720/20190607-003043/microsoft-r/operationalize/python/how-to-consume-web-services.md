...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: f2f5e2ed980b15dc162f7c1ed5b603b8980e4638
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="list-get-and-consume-web-services-in-python"></a>List, get, and consume web services in Python
...
## <a name="find-and-list-web-services"></a>Find and list web services
...
## <a name="retrieve-and-examine-service-objects"></a>Retrieve and examine service objects
...
## <a name="consume-web-services"></a>Consume web services 
...
### <a name="consuming-in-python"></a>Consuming in Python
...
### <a name="sharing-the-swagger-with-application-developers"></a>Sharing the Swagger with application developers

Application developers can call and integrate a web service into their applications using the service-specific Swagger-based JSON file and by providing any required inputs to that service. The Swagger-based JSON file is used to generate client libraries for integration. Read "[How to integrate web services and authentication into your application](../how-to-build-api-clients-from-swagger-for-app-integration.md)" for more details.  
