...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 9b50f893c052aff89e9ca0c1687039d042841e99
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="roles-and-permissions-rbac"></a>Roles and permissions (RBAC)
...
## <a name="security-groups-versus-machine-learning-server-roles"></a>Security groups versus Machine Learning Server roles
...
## <a name="roles-and-their-permissions"></a>Roles and their permissions
...
## <a name="how-are-roles-assigned"></a>How are roles assigned
...
## <a name="role-configuration-states"></a>Role configuration states
...
## <a name="how-to-declare-roles"></a>How to declare roles
...
### <a name="step-1-define-desired-roles"></a>Step 1. Define desired roles
...
### <a name="step-2-validate-groups-against-adldap-or-aad"></a>Step 2. Validate groups against AD/LDAP or AAD
...
### <a name="step-3-apply-the-changes-to-machine-learning-server--r-server"></a>Step 3. Apply the changes to Machine Learning Server / R Server
...
## <a name="web-service-permissions-after-role-change"></a>Web service permissions after role change
