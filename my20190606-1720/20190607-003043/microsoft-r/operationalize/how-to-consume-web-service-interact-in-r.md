...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: a195b9ea05e96df5a2c9867a5be6dc5723e5ef9a
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="how-to-interact-with-and-consume-web-services-in-r-with-mrsdeploy"></a>How to interact with and consume web services in R with mrsdeploy 
...
## <a name="interact-with-api-clients"></a>Interact with API clients
...
#### <a name="collaborate-with-data-scientists"></a>Collaborate with data scientists
...
#### <a name="collaborate-with-application-developers"></a>Collaborate with application developers
