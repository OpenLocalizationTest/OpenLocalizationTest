...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 1a803335ef000b9b07989b500ebe90cbaf070862
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="configuring-an-sql-server-or-postgresql-database-for-machine-learning-server"></a>Configuring an SQL Server or PostgreSQL database for Machine Learning Server
