...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 41886388abb31a4a2b7e1475cc9050d75b44c505
...
## <a name="if-i-want-to-use-the-deployr-web-server-for-my-web-application-where-should-i-put-my-application-files"></a>If I want to use the DeployR Web server for my Web application, where should I put my application files?
...
## <a name="im-having-issues-after-installing-deployr-where-do-i-go-for-answers"></a>I'm having issues after installing DeployR. Where do I go for answers?
...
## <a name="why-cant-i-reach-deployr-landing-page-anymore"></a>Why can't I reach DeployR landing page anymore?
...
## <a name="how-does-deployr-compare-to-shiny"></a>How does DeployR compare to Shiny?
