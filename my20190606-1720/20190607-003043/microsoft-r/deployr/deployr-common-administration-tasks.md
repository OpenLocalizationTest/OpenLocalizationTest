...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 1c42ee264dce07e0eb768521fcd85c21c112953b
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="common-deployr-administration-tasks"></a>Common DeployR Administration Tasks
...
<a name="startstop"></a>
## <a name="starting-and-stopping-deployr-for-microsoft-r-server-805"></a>Starting and Stopping DeployR for Microsoft R Server 8.0.5
...
## <a name="starting-and-stopping-deployr-800"></a>Starting and Stopping DeployR 8.0.0
...
## <a name="inspecting-server-logs"></a>Inspecting Server Logs
...
### <a name="api-call--response-events"></a>API Call / Response Events
...
### <a name="http-session-events"></a>HTTP Session Events
...
### <a name="grid-r-session-events"></a>Grid R Session Events
...
### <a name="tracing-related-log-events"></a>Tracing Related Log Events
...
## <a name="backing-up-and-restoring-data"></a>Backing Up and Restoring Data
...
## <a name="opening-deployr-ports"></a>Opening DeployR Ports
