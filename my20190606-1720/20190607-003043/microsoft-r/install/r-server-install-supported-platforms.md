...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 0d0e382ca6409778967caf34260db94886698045
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="supported-platforms-for-machine-learning-server-and-microsoft-r-server"></a>Supported platforms for Machine Learning Server and Microsoft R Server
...
## <a name="microsoft-r-server-91"></a>Microsoft R Server 9.1
...
## <a name="end-of-life-versions"></a>End of Life versions
