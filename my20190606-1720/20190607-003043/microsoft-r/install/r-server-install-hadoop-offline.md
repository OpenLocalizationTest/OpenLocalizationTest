...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: a354aaf40f4e892afa78e40ed908cd7b23009503
ms.sourcegitcommit: 5a1af0c1-a46b-4161-9fcd-2c6c2f004c37
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="offline-installation-of-r-server-91-for-hadoop"></a>Offline installation of R Server 9.1 for Hadoop
...
## <a name="download-r-server-dependencies"></a>Download R Server dependencies
...
## <a name="download-package-dependencies"></a>Download package dependencies
...
## <a name="transfer-files"></a>Transfer files
...
## <a name="install-package-dependencies"></a>Install package dependencies
...
## <a name="unpack-net-core-and-set-symbolic-link"></a>Unpack .NET Core and set symbolic link
...
## <a name="unpack-mrs-distribution-and-copy-mro"></a>Unpack MRS distribution and copy MRO
