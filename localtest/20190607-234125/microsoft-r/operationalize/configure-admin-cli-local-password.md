...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 001b4429943dfedadb3d5bda847904a8f15a5fd8
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="set-or-update-the-local-administrator-password"></a>Set or update the local administrator password
