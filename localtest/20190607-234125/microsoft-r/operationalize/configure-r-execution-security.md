...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 287a3695db0783031decf54f53404021bcc236f2
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="r-execution-security-considerations"></a>R Execution Security Considerations
...
## <a name="the-execution-context"></a>The Execution Context
...
## <a name="directory--user-isolation-considerations"></a>Directory & User Isolation Considerations
