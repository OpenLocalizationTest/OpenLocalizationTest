...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 0df7a834727c3fb5b679697538ddd33a521e492c
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="troubleshooting--diagnostics-for-machine-learning-server"></a>Troubleshooting & diagnostics for Machine Learning Server
...
## <a name="test-your-configuration"></a>Test your configuration
...
## <a name="trace-a-code-execution"></a>Trace a code execution 
...
## <a name="trace-a-web-service-execution"></a>Trace a web service execution
...
## <a name="log-files-and-levels"></a>Log files and levels

Review the log and configuration files for any component that was identified as experiencing issues. You can find the logs in the **\<node-install-path>\logs** folder under your web and compute node installation paths. (Locate the [install path](configure-find-admin-configuration-file.md) for your version.) 
...
## <a name="trace-user-actions"></a>Trace user actions
...
### <a name="backendconfiguration-is-missing-uri-error"></a>"BackEndConfiguration is missing URI" Error
...
### <a name="cannot-establish-connection-with-the-web-node-error"></a>“Cannot establish connection with the web node” Error
...
### <a name="long-delays-when-consuming-web-service-on-spark"></a>Long delays when consuming web service on Spark
...
### <a name="compute-node-failed--http-status-503-on-apis-901---linux-only"></a>Compute Node Failed / HTTP status 503 on APIs (9.0.1 - Linux Only)
...
### <a name="unauthorized--http-status-401"></a>Unauthorized / HTTP status 401
...
### <a name="configuration-did-not-restore-after-upgrade"></a>Configuration did not restore after upgrade
...
### <a name="alphanumeric-error-message-when-consuming-service"></a>Alphanumeric error message when consuming service
...
### <a name="failed-code-execution-with-servicebusyexception-in-the-log"></a>Failed code execution with “ServiceBusyException” in the log
...
### <a name="error-microsoftaspnetcoreserverkestrelinternalnetworkinguvexception-error--97-eafnosupport-address-family-not-supported"></a>Error: "Microsoft.AspNetCore.Server.Kestrel.Internal.Networking.UvException: Error -97 EAFNOSUPPORT address family not supported"
...
### <a name="az-error-argument-commandpackage-invalid-choice-ml"></a>az: error: argument command_package: invalid choice: ml
