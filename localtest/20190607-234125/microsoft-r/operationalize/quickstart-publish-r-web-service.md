...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 503d4f514b1212985c648c1de287c5c69150e613
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="quickstart-deploy-an-r-model-as-a-web-service-with-mrsdeploy"></a>Quickstart: Deploy an R Model as a web service with mrsdeploy
...
## <a name="a-model-locally"></a>A. Model locally
...
## <a name="b-publish-model-as-a-web-service"></a>B. Publish model as a web service
...
## <a name="c-consume-the-service-in-r-to-test"></a>C. Consume the service in R to test
...
## <a name="d-get-the-swagger-based-json-file"></a>D. Get the Swagger-based JSON file
...
## <a name="how-to-execute-r-code-remotely"></a>How to execute R code remotely
