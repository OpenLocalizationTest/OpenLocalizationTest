...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 227ffb3f1a975b9ebfbecdfdd268a050a1a48092
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="how-to-create-and-manage-session-pools-for-fast-web-service-connections-in-python"></a>How to create and manage session pools for fast web service connections in Python
