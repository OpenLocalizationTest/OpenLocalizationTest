...
ms.topic: conceptual
ms.prod: r-services
ms.openlocfilehash: dc7578d81b81a0034a4792eef2d280041fbe2b51
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="using-revoscaler-with-sql-server"></a>Using RevoScaleR with SQL Server
...
## <a name="basic-operations"></a>Basic Operations
...
### <a name="getting-sql-server-data"></a>Getting SQL Server Data
...
## <a name="related-guides"></a>Related Guides
