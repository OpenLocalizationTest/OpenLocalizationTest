...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: cb6cdab3a6fc7cd36a654688bc47abbe4a246eed
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="r-productivity-environment-getting-started-guide"></a>R Productivity Environment Getting Started Guide
...
## <a name="a-tutorial-introduction-to-revolution-r-enterprise"></a>A Tutorial Introduction to Revolution R Enterprise
...
### <a name="create-a-simple-solution-satscores"></a>Create a Simple Solution: *SATscores*
...
### <a name="add-a-data-set-to-your-solution"></a>Add a Data Set to Your Solution
...
### <a name="use-the-script-editor"></a>Use the Script Editor

#### <a name="edit-a-script"></a>Edit a script
...
#### <a name="use-a-code-snippet-to-import-the-data-into-r"></a>Use a code snippet to import the data into R
...
### <a name="see-your-objects-in-the-object-browser"></a>See Your Objects in the Object Browser
...
### <a name="create-a-plot"></a>Create a Plot
...
### <a name="run-selected-text"></a>Run Selected Text
...
### <a name="use-summary-statistics"></a>Use Summary Statistics
...
### <a name="create-a-categorical-variable"></a>Create a Categorical Variable
...
### <a name="create-a-conditioning-plot"></a>Create a Conditioning Plot
...
### <a name="create-another-script-and-write-a-function"></a>Create Another Script and Write a Function
...
### <a name="open-and-run-an-existing-script"></a>Open and Run an Existing Script
...
## <a name="using-the-debugger"></a>Using the Debugger
...
### <a name="switch-to-debug-configuration"></a>Switch to Debug Configuration
...
### <a name="set-a-breakpoint"></a>Set a Breakpoint
...
### <a name="step-in-the-debugger"></a>Step In the Debugger
...
### <a name="examine-local-values"></a>Examine Local Values
...
## <a name="enhanced-script-editing-capabilities"></a>Enhanced Script Editing Capabilities

Revolution R Enterprise offers a full-featured script editor with many enhanced script editing capabilities.

### <a name="automatic-syntax-checking"></a>Automatic Syntax Checking
...
### <a name="use-intellisense-to-type-object-names"></a>Use IntelliSense to Type Object Names
...
### <a name="use-intellisense-to-complete-function-arguments"></a>Use IntelliSense to Complete Function Arguments
...
### <a name="use-intellisense-to-see-object-information"></a>Use IntelliSense to See Object Information
...
### <a name="comment-and-uncomment-sections-of-code"></a>Comment and Uncomment Sections of Code
...
### <a name="hide-and-show-sections-of-code"></a>Hide and Show Sections of Code
...
### <a name="record-and-run-a-simple-macro"></a>Record and Run a Simple Macro
...
## <a name="editing-data"></a>Editing Data
...
## <a name="installing-and-loading-r-packages"></a>Installing and Loading R Packages
...
## <a name="working-with-multiple-scripts"></a>Working With Multiple Scripts

### <a name="use-find-in-files"></a>Use Find in Files
...
### <a name="use-quick-replace"></a>Use Quick Replace
...
### <a name="use-bookmarks"></a>Use Bookmarks
...
### <a name="use-the-navigate-buttons"></a>Use the Navigate Buttons
...
## <a name="macros-associating-with-keyboard-shortcuts-and-saving"></a>Macros: Associating with Keyboard Shortcuts and Saving


### <a name="save-a-temporary-macro"></a>Save a Temporary Macro
...
### <a name="associate-a-new-macro-with-a-keyboard-shortcut"></a>Associate a New Macro with a Keyboard Shortcut
...
### <a name="assign-a-macro-to-a-toolbar-button"></a>Assign a Macro to a Toolbar Button
...
## <a name="using-the-r-console"></a>Using the R Console
...
### <a name="clear-the-console-window"></a>Clear the Console Window

If you would like to clear the Console window, right click in the window and choose **Clear All**.

### <a name="enter-commands"></a>Enter Commands
...
### <a name="retrieve-a-previous-command"></a>Retrieve a Previous Command
...
## <a name="keyboard-navigation-among-windows"></a>Keyboard Navigation Among Windows
