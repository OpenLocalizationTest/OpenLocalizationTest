...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 7014dd7473bd42c16904103bae6838f4685ce290
...
## <a name="about-file-properties"></a>About File Properties
...
## <a name="the-files-you-own"></a>The Files You Own
...
## <a name="the-files-you-dont-own"></a>The Files You Don't Own
...
## <a name="copying-files"></a>Copying Files
...
## <a name="moving-files"></a>Moving Files
...
## <a name="editing-file-properties"></a>Editing File Properties
...
## <a name="sharing-files-with-others"></a>Sharing Files with Others
...
## <a name="adding-and-removing-owners"></a>Adding and Removing Owners
...
## <a name="working-with-historical-versions"></a>Working with Historical Versions
...
<br>
### <a name="comparing-version-differences"></a>Comparing Version Differences
...
<br>
### <a name="reverting-a-past-version-to-the-latest-version"></a>Reverting a Past Version to the Latest Version
...
## <a name="deleting-files"></a>Deleting Files
