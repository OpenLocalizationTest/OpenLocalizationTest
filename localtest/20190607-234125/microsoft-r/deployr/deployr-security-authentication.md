...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 68e308020fc1d8e0b32ca1fb8f85a55b971d206c
...
<a name="ldap"></a>
## <a name="ldap--ldap-s-authentication"></a>LDAP / LDAP-S Authentication
...
## <a name="ldap--active-directory-configuration-properties"></a>LDAP & Active Directory Configuration Properties
...
## <a name="pam-authentication"></a>PAM Authentication
...
## <a name="ca-single-sign-on-siteminder-pre-authentication"></a>CA Single Sign-On (SiteMinder) Pre-Authentication
...
## <a name="r-session-process-controls"></a>R Session Process Controls
...
### <a name="step-1-update-process-control-properties"></a>Step 1: Update Process Control Properties
...
### <a name="step-2-make-system-level-configuration-changes-to-every-node"></a>Step 2: Make System-Level Configuration Changes to Every Node
