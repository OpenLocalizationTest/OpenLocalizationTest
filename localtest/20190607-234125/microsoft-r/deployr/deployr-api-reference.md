...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: f8f1779588b363d4f2475aed3ec642a857854f27
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="deployr-api-overview"></a>DeployR API Overview
...
## <a name="r-for-application-developers"></a>R for Application Developers
...
<a name="users"></a>
## <a name="users-on-the-api"></a>Users on the API
...
## <a name="projects-on-the-api"></a>Projects on the API
...
### <a name="anonymous-projects"></a>Anonymous Projects
...
### <a name="authenticated-projects"></a>Authenticated Projects
...
<br />
### <a name="live-projects-on-the-grid"></a>Live Projects on the Grid
...
<br />
### <a name="working-with-project-management-apis"></a>Working with Project Management APIs
...
<br />
### <a name="project-ownership-amp-collaboration"></a>Project Ownership &amp; Collaboration
...
<br />
<a name="projexec"></a>
### <a name="project-execution-apis"></a>Project Execution APIs
...
### <a name="project-workspace-apis"></a>Project Workspace APIs
...
<br />
<a name="projdir"></a>
### <a name="project-directory-apis"></a>Project Directory APIs
...
<br />
<a name="projpkg"></a>
### <a name="project-package-apis"></a>Project Package APIs
...
## <a name="jobs-on-the-api"></a>Jobs on the API
...
#### <a name="submitting-versus-scheduling-jobs"></a>Submitting Versus Scheduling Jobs
...
#### <a name="job-scheduling-priority"></a>Job Scheduling Priority
...
#### <a name="retrieving-job-results"></a>Retrieving Job Results
...
#### <a name="understanding-the-jobs-lifecycle"></a>Understanding the Jobs Lifecycle
...
<a name="repository"></a>
## <a name="repository-on-the-api"></a>Repository on the API
...
<br />
<a name="repodir"></a>
### <a name="repository-directories"></a>Repository Directories
...
<br />
#### <a name="user-directories"></a>User Directories
...
#### <a name="system-directories"></a>System Directories
...
<br />
### <a name="repository-managed-files"></a>Repository-Managed Files
...
<a name="repofiles"></a>
#### <a name="repository-file-apis"></a>Repository File APIs
...
### <a name="repository-managed-scripts"></a>Repository-Managed Scripts
...
#### <a name="working-with-the-repository-script-apis"></a>Working with the Repository Script APIs
...
<br />
## <a name="event-stream"></a>Event Stream
...
<br />
### <a name="stream-lifecycle-events"></a>Stream Lifecycle Events
...
<br />
### <a name="execution-events"></a>Execution Events
...
<br />
### <a name="job-lifecycle-events"></a>Job Lifecycle Events
...
<br />
### <a name="management-events"></a>Management Events
...
### <a name="authenticated-anonymous-and-management-event-streams"></a>Authenticated, Anonymous, and Management Event Streams
...
## <a name="deployr-web-services-api-overview"></a>DeployR Web Services API Overview
...
<br />
### <a name="api-parameter-overview"></a>API Parameter Overview
...
<br />
<a name="codes"></a>
### <a name="api-response-code-overview"></a>API Response Code Overview
...
### <a name="api-call-overview"></a>API Call Overview
...
<a name="encoding"></a>
## <a name="encode-r-object-data-for-use-on-the-api"></a>Encode R Object Data for use on the API
...
<br />
## <a name="api-change-history"></a>API Change History

<br />
<a name="805"></a>
### <a name="deployr-for-microsoft-r-server-805"></a>DeployR for Microsoft R Server 8.0.5
...
<br />
### <a name="deployr-800"></a>DeployR 8.0.0
...
<br />
### <a name="deployr-741"></a>DeployR 7.4.1
...
<br />
### <a name="deployr-74"></a>DeployR 7.4

#### <a name="grid-cluster-targeted-executions"></a>Grid Cluster Targeted Executions
...
#### <a name="project-phantom-executions"></a>Project Phantom Executions
...
#### <a name="external-repository-support"></a>External Repository Support
...
#### <a name="default-and-external-repository-filters"></a>Default and External Repository Filters
...
#### <a name="repository-shell-script-execution"></a>Repository Shell Script Execution
...
<br />
### <a name="deployr-73"></a>DeployR 7.3

#### <a name="user-grid-resource-release-api"></a>User Grid Resource Release API
...
#### <a name="standard-execution-model-changes"></a>Standard Execution Model Changes
