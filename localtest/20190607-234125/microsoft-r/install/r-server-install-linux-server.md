...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 2e474641fa0c899f47b466c63be9c43847f2d145
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="r-server-91-installation-for-linux-systems"></a>R Server 9.1 Installation for Linux Systems
...
## <a name="see-also"></a>See Also
 ...
 [Uninstall Microsoft R Server to upgrade to a newer version](r-server-install-linux-uninstall.md) [Troubleshoot R Server installation problems on Hadoop](r-server-install-hadoop-troubleshoot.md)  
