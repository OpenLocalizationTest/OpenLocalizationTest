...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: e747e90eea7c47d24f180aae912c6aaae1727137
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="install-machine-learning-server-for-windows"></a>Install Machine Learning Server for Windows
...
## <a name="upgrade-existing-installations"></a>Upgrade existing installations
...
## <a name="download-machine-learning-server-installer"></a>Download Machine Learning Server installer
...
### <a name="check-log-files"></a>Check log files
...
## <a name="enable-web-service-deployment-and-remote-connections"></a>Enable web service deployment and remote connections
...
## <a name="whats-installed"></a>What's installed
