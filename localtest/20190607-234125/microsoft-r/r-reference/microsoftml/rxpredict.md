...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 4a5e33a88bb66a9eb3525b1a8178e3af99ddbc2b
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="rxpredictmlmodel-score-using-a-microsoft-r-machine-learning-model"></a>rxPredict.mlModel: Score using a Microsoft R Machine Learning model 
...
[rxFastTrees](rxFastTrees.md), [rxFastForest](rxFastForest.md), [rxLogisticRegression](rxLogisticRegression.md), [rxNeuralNet](rxNeuralNet.md), [rxOneClassSvm](rxOneClassSvm.md).
