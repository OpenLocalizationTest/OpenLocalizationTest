...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 8752b842dd573571a0ba5eef8b1b45a5cb2abfd4
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="mutualinformation-feature-selection-mutual-information-mode"></a>mutualInformation: Feature Selection Mutual Information Mode 
 ## <a name="description"></a>Description

Mutual information mode of feature selection used in the feature selection transform [selectFeatures](selectFeatures.md).
