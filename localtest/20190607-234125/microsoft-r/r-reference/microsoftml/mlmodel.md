...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: f801904ef6e54c045767a861f7458934da72649e
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="summarymlmodel-summary-of-a-microsoft-r-machine-learning-model"></a>summary.mlModel: Summary of a Microsoft R Machine Learning model. 
...
For [rxLogisticRegression](rxLogisticRegression.md), the following statistics may also present in the summary when `showTrainingStats` is set to `TRUE`.
...
[rxFastTrees](rxFastTrees.md), [rxFastForest](rxFastForest.md), [rxFastLinear](rxFastLinear.md), [rxOneClassSvm](rxOneClassSvm.md), [rxNeuralNet](rxNeuralNet.md), [rxLogisticRegression](rxLogisticRegression.md).
