...
ms.topic: reference
ms.prod: mlserver
ms.openlocfilehash: 502af974c2e4567706d030df7212d52e895be8e4
...
## <a name="how-to-use-revoscaler"></a>How to use RevoScaleR
...
### <a name="run-it-locally"></a>Run it locally
...
### <a name="run-in-a-remote-compute-context"></a>Run in a remote compute context
...
## <a name="typical-workflow"></a>Typical workflow
<!--<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
## <a name="1-data-source-functions"></a>1-Data source functions
...
## <a name="2-import-and-save-as"></a>2-Import and save-as
...
## <a name="3-data-transformation"></a>3-Data transformation
...
## <a name="4-graphing-functions"></a>4-Graphing functions
...
## <a name="5-descriptive-statistics"></a>5-Descriptive statistics
...
## <a name="6-prediction-functions"></a>6-Prediction functions
...
## <a name="7-compute-context-functions"></a>7-Compute context functions
...
## <a name="8-distributed-computing"></a>8-Distributed computing
...
## <a name="9-utility-functions"></a>9-Utility functions
...
## <a name="10-package-management"></a>10-Package management
