...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: e97c5dcdbd1b90a74946c9e3eaafe4abdfae6c56
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="rxremovepackages-remove-packages-from-compute-context"></a>rxRemovePackages: Remove Packages from Compute Context 
...
[rxPackage](rxPackage.md), remove.packages, [rxFindPackage](rxFindPackage.md), [rxInstalledPackages](rxInstalledPackages.md), [rxInstallPackages](rxInstallPackages.md),  
[rxSyncPackages](rxSyncPackages.md), [rxSqlLibPaths](rxSqlLibPaths.md),   
require
