...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 629a446815634a68e74feeafbd35790038592d7d
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
 # <a name="setinputparametervalue-assign-a-value-to-the-input-data-parameter-of-the-sql-stored-procedure"></a>setInputParameterValue: Assign a Value to the Input Data Parameter of the SQL Stored Procedure 
