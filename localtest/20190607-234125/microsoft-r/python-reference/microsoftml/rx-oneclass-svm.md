...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: b5a4099beda8ff058c026be5bf5a7d6aa01ead8c
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="microsoftmlrxoneclasssvm-anomaly-detection"></a>*microsoftml.rx_oneclass_svm*: Anomaly Detection
...
One-class SVM is an algorithm for anomaly detection. The goal of anomaly detection is to identify outliers that do not belong to some target class.
...
`linear_kernel`, `polynomial_kernel`, `rbf_kernel`, `sigmoid_kernel`, [`rx_predict`](rx-predict.md).
