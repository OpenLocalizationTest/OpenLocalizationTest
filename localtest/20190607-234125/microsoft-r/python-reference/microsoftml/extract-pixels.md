...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: dd48bea546a14f589bbf1e237af5f25a4fc3300d
ms.sourcegitcommit: 482448f7-1a28-4b2f-b7c2-911be7144b02
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/07/2019
---
# <a name="microsoftmlextractpixels-extracts-pixels-from-an-image"></a>*microsoftml.extract_pixels*: Extracts pixels from an image
...
[`load_image`](load-image.md), [`resize_image`](resize-image.md), [`featurize_image`](featurize-image.md).
