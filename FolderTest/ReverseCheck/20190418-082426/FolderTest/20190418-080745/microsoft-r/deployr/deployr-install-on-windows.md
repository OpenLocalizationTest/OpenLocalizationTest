...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: b3eec7c4914c195e93c21c47a17c133d21a015eb
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="installing-deployr-for-microsoft-r-server-2016-805-on-windows"></a>Installing DeployR for Microsoft R Server 2016 (8.0.5) on Windows
...
## <a name="installing-deployr-server"></a>Installing DeployR Server
...
<a name="gridnodes"></a>
### <a name="installing-deployr-grid-nodes"></a>Installing DeployR Grid Nodes
...
<a name="sqlserver"></a>
### <a name="using-a-sql-server-database"></a>Using a SQL Server Database
...
### <a name="setting-password-on-testuser-account"></a>Setting Password on Testuser Account
...
<a name="migrate"></a>
## <a name="migrating-to-deployr-for-microsoft-r-server-2016"></a>Migrating to DeployR for Microsoft R Server 2016 
