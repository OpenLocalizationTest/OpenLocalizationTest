...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 5d5c0b18eb1975ff4499b2ef8033492f5d216673
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="configure-ssltls-for-deployr-https"></a>Configure SSL/TLS for DeployR (HTTPS)
...
## <a name="enabling-tlsssl-support"></a>Enabling TLS/SSL Support
...
<br />
### <a name="enabling-for-deployr-for-microsoft-r-server-805"></a>Enabling for DeployR for Microsoft R Server 8.0.5

<br />
#### <a name="securing-connections-between-the-deployr-web-server-and-client"></a>Securing connections between the DeployR Web server and client
...
<br />
#### <a name="securing-connections-between-deployr-web-server-and-the-database"></a>Securing connections between DeployR Web server and the database
...
<br>
### <a name="enabling-for-deployr-800"></a>Enabling for DeployR 8.0.0
...
### <a name="generating-a-temporary-keystore"></a>Generating a Temporary Keystore
...
## <a name="disabling-ssl-support"></a>Disabling SSL Support

### <a name="disabling-for-deployr-for-microsoft-r-server-805"></a>Disabling for DeployR for Microsoft R Server 8.0.5
...
### <a name="disabling-for-deployr-800"></a>Disabling for DeployR 8.0.0
