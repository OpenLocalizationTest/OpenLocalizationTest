...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 4f92257578c5aa2213e76ad39627af721523385d
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="configuring-ca-single-sign-on-for-deployr"></a>Configuring CA Single Sign-On for DeployR
...
## <a name="create-the-agent"></a>Create the Agent
...
## <a name="create-the-agent-group"></a>Create the Agent Group
...
## <a name="create-agent-configuration-object"></a>Create Agent Configuration Object
...
### <a name="configure-agent-configuration-object"></a>Configure Agent Configuration Object
...
## <a name="create-the-domain"></a>Create the Domain
...
## <a name="create-the-realm--sub-realms"></a>Create the Realm & Sub-Realms
...
## <a name="create-responses"></a>Create Responses
...
## <a name="create-response-groups"></a>Create Response Groups
