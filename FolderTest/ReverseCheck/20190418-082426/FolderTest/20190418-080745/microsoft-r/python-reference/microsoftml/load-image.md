...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 068e071de14b0adf356f591e31dd3959db8dd1be
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="microsoftmlloadimage-loads-an-image"></a>*microsoftml.load_image*: Loads an image
...
[`resize_image`](resize-image.md), [`extract_pixels`](extract-pixels.md), [`featurize_image`](featurize-image.md).
