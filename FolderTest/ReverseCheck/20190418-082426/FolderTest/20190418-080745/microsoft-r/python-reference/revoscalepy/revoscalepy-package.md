...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 5608c4f7e1982b34525fbfb6220b7feda6e926fd
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="revoscalepy-package"></a>revoscalepy package
...
## <a name="how-to-use-revoscalepy"></a>How to use revoscalepy
...
## <a name="1-compute-context-functions"></a>1-Compute context functions
...
## <a name="2-data-source-functions"></a>2-Data source functions
...
## <a name="3-data-manipulation-etl-functions"></a>3-Data manipulation (ETL) functions
...
## <a name="4-analytic-functions"></a>4-Analytic functions
...
## <a name="5-job-functions"></a>5-Job functions
...
## <a name="6-serialization-functions"></a>6-Serialization functions
...
## <a name="7-utility-functions"></a>7-Utility functions
