...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 0429507ea7f28f77eda35e2abcfcd7f386efb345
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="mincount-feature-selection-count-mode"></a>minCount: Feature Selection Count Mode 
 ## <a name="description"></a>Description

Count mode of feature selection used in the feature selection transform [selectFeatures](selectFeatures.md).
