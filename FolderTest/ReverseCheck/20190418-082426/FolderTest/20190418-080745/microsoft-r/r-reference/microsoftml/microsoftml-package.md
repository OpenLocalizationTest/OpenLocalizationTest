...
ms.service: ''
ms.assetid: ''
ms.openlocfilehash: d79e4d1d49cc35ccb997606aefddebfe503c4e69
...
## <a name="how-to-use-microsoftml-for-r"></a>How to use MicrosoftML for R
...
## <a name="1-machine-learning-algorithms"></a>1-Machine learning algorithms
...
## <a name="2-transformation-functions"></a>2-Transformation functions
...
## <a name="3-scoring-and-training-functions"></a>3-Scoring and training functions
...
## <a name="4-loss-functions-for-classification-and-regression"></a>4-Loss functions for classification and regression
...
## <a name="5-feature-selection-functions"></a>5-Feature selection functions
...
## <a name="6-ensemble-modeling-functions"></a>6-Ensemble modeling functions
...
## <a name="7-neural-networking-functions"></a>7-Neural networking functions
...
## <a name="8-package-state-functions"></a>8-Package state functions
