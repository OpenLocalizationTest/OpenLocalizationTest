...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: fa8cb68d07ec43f36fe40aa706b665127ef763db
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="stopwordsdefault-machine-learning-text-transform"></a>stopwordsDefault: Machine Learning Text Transform 
...
The n-grams are represented as count vectors, with vector slots corresponding either to n-grams (created using `ngramCount`) or to their hashes (created using `ngramHash`). Embedding ngrams in a vector space allows their contents to be compared in an efficient manner.
...
[ngramCount](ngram.md), [ngramHash](ngram.md), [rxFastTrees](rxFastTrees.md), [rxFastForest](rxFastForest.md), [rxNeuralNet](rxNeuralNet.md), [rxOneClassSvm](rxOneClassSvm.md), [rxLogisticRegression](rxLogisticRegression.md).
