...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: cf87c3375d1bbf8642c220bf6c77230e4497f79c
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="rxodbcdata-generate-odbc-data-source-object"></a>RxOdbcData: Generate ODBC Data Source Object 
...
[RxOdbcData-class](RxOdbcData-class.md), [rxNewDataSource](rxNew.md), [rxImport](rxImport.md), [RxTeradata](RxTeradata.md).
