...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: f1f5ea42bca81bb37ca1030041fec5b033fa22e6
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="rxrealtimescoring-real-time-scoring-in-sql-server-ml-services"></a>rxRealTimeScoring: Real-time scoring in SQL Server ML Services 
...
[rxSerializeModel](rxSerializeModel.md), [rxWriteObject](rxWriteObject.md), publishService, [rxPredict](rxPredict.md)
