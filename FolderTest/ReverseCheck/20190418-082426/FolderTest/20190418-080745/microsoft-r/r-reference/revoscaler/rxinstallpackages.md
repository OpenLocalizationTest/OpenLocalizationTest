...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 839558b0307fafc1c7de9a1c4ad1b17eb713a0cf
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="rxinstallpackages-install-packages-for-compute-context"></a>rxInstallPackages: Install Packages for Compute Context 
...
[rxPackage](rxPackage.md), install.packages, [rxFindPackage](rxFindPackage.md), [rxInstalledPackages](rxInstalledPackages.md), [rxRemovePackages](rxRemovePackages.md), [rxSyncPackages](rxSyncPackages.md), [rxSqlLibPaths](rxSqlLibPaths.md),   
require
