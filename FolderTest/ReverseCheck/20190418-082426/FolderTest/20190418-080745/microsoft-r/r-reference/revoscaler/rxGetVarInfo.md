...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 7efe56c0c0078b3cac027e51d2db6042d771d0b3
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="rxgetvarinfo-get-variable-information-for-a-data-source"></a>rxGetVarInfo: Get Variable Information for a Data Source 
...
If the [RxComputeContext](RxComputeContext.md) is distributed, `rxGetVarInfo` will request information from the compute context nodes.  
...
[rxSetVarInfo](rxSetVarInfoXdf.md), [rxDataStep](rxDataStep.md).
