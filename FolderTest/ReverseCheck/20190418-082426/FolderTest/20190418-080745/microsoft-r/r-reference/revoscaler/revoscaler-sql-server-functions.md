...
ms.topic: reference
ms.prod: mlserver
ms.openlocfilehash: 49459e0dbeb50ed697a46bf38ef092bd124615f2
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="revoscaler-functions-for-a-sql-server-compute-context"></a>RevoScaleR Functions for a SQL Server compute context
...
## <a name="functions-for-working-with-sql-server-data-sources"></a>Functions for working with SQL Server Data Sources
...
## <a name="functions-for-defining-or-managing-a-compute-context"></a>Functions for Defining or Managing a Compute Context
...
## <a name="functions-for-using-a-data-source"></a>Functions for Using a Data Source
...
## <a name="functions-that-work-with-xdf-files"></a>Functions that work with XDF Files
