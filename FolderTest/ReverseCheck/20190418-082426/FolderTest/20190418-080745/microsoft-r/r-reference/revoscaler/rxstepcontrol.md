...
ms.tgt_pltfrm: ''
ms.custom: ''
ms.openlocfilehash: 5c1ee7def7f3279842e58d9e47e84cb145e6378e
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
 # <a name="rxstepcontrol-control-for-stepwise-regression"></a>rxStepControl: Control for Stepwise Regression 
...
Stepwise models must be computed on the same dataset in order to be compared so rows with missing values in any of the variables in the upper model are removed before the model fitting starts.
Consequently, the stepwise models might be different from the corresponding models fitted with only the selected variables if there are missing values in the data set.
...
*The American Statistician* Vol. **33** No. **3**, 149--158.
