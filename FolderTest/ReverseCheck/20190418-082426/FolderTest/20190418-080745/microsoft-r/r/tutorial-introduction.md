...
ms.prod: mlserver
ms.technology: ''
ms.openlocfilehash: 4cf9afac4b5d42727a4162366d2d761248283039
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="tutorials-and-sample-data-for-machine-learning-server"></a>Tutorials and sample data for Machine Learning Server
...
## <a name="move-forward-with-larger-data-sets"></a>Move forward with larger data sets
...
## <a name="platform-ramp-up"></a>Platform ramp-up
...
## <a name="custom-code"></a>Custom code

+ [Get Started with PemaR](how-to-developer-pemar.md)

## <a name="find-sample-data"></a>Find sample data
...
## <a name="see-also"></a>See Also
 ...
 [What's new in Machine Learning Server](../whats-new-in-machine-learning-server.md) [Tips on computing with big data](tutorial-large-data-tips.md) [How to guidance](how-to-introduction.md)