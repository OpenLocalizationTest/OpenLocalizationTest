...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 6d4f1438289fe56b0a76ef703141fd6a43a80f37
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="cheat-sheet-how-to-choose-a-microsoftml-algorithm"></a>Cheat sheet: How to choose a MicrosoftML algorithm
...
## <a name="download-the-microsoftml-algorithm-cheat-sheet"></a>Download the MicrosoftML Algorithm Cheat Sheet
...
## <a name="microsoftml-machine-learning-algorithms"></a>MicrosoftML machine learning algorithms
...
### <a name="fast-linear-model-sdca"></a>Fast Linear model (SDCA)
...
### <a name="oneclass-svm"></a>OneClass SVM
...
### <a name="fast-forest"></a>Fast Forest
...
### <a name="ensemble-methods"></a>Ensemble methods
...
## <a name="notes-and-terminology-definitions-for-the-machine-learning-algorithm-cheat-sheet"></a>Notes and terminology definitions for the machine learning algorithm cheat sheet
