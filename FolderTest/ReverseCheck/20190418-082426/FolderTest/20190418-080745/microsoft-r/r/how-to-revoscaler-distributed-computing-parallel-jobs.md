...
### <a name="naveparallelk-meansclustering"></a>Naïve Parallel k-Means Clustering
...
## <a name="use-rxexec-in-the-local-compute-context"></a>Use rxExec in the local compute context
