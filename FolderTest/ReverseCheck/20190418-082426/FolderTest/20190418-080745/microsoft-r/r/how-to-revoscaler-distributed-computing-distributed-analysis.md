...
## <a name="perform-an-rxcube-computation"></a>Perform an rxCube computation
...
## <a name="compute-a-covariance-or-correlation-matrix"></a>Compute a Covariance or Correlation Matrix
