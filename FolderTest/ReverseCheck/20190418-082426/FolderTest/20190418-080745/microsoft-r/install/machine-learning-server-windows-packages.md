...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: dd467dabe0fec17423410396d782b6a25fa2c87e
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="how-to-add-or-remove-r-and-python-packages-on-machine-learning-server-for-windows"></a>How to add or remove R and Python packages on Machine Learning Server for Windows
