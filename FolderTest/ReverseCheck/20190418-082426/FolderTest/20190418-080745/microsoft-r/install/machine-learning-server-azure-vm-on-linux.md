...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 217e6d034ac01dd33073cbd00d7cf695e37c3aa0
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="machine-learning-server-on-azure-virtual-machines"></a>Machine Learning Server on Azure Virtual Machines
...
## <a name="vm-images-on-azure"></a>VM images on Azure 
...
## <a name="how-to-provision-with-templates"></a>How to provision with templates
...
## <a name="how-to-provision-in-the-portal"></a>How to provision in the portal
...
## <a name="launch-r-server"></a>Launch R Server
...
## <a name="configure-an-r-ide"></a>Configure an R IDE
...
#### <a name="configure-rstudio-for-machine-learning-server"></a>Configure RStudio for Machine Learning Server
  1. Launch RStudio.
...
#### <a name="open-ports-needed-to-use-rstudio-server"></a>Open Ports needed to Use RStudio Server
...
#### <a name="assign-a-fully-qualified-domain-name-to-the-vm-for-accessing-rstudio-server"></a>Assign a Fully Qualified Domain Name to the VM for Accessing RStudio Server
...
## <a name="operationalize-r-and-python-analytics-with-machine-learning-server-on-the-vm"></a>Operationalize R and Python Analytics with Machine Learning Server on the VM
...
## <a name="access-data-in-an-azure-storage-account"></a>Access Data in an Azure Storage Account
...
## <a name="resources--documentation"></a>Resources & Documentation
