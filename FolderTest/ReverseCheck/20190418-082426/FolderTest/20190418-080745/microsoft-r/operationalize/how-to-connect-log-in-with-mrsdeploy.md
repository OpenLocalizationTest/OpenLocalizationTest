...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 907d42c850fbc20bdf117798b888d84dccbd3aee
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="log-in-to-machine-learning-server-or-r-server-with-mrsdeploy-and-open-a-remote-session"></a>Log in to Machine Learning Server or R Server with mrsdeploy and open a remote session
...
### <a name="arguments-for-remote-execution"></a>Arguments for remote execution 
...
## <a name="remote-connection-states"></a>Remote connection states                                                                                                                                                        
...
### <a name="create-remote-r-session-and-go-to-remote-command-line-1"></a>Create remote R session and go to remote command line (1)
...
### <a name="create-remote-r-session-and-remain-with-local-command-line-2"></a>Create remote R session and remain with local command line (2)
...
### <a name="remain-local-without-creating-a-remote-r-session-3"></a>Remain local without creating a remote R session (3)
...
## <a name="switch-between-remote-and-local-sessions"></a>Switch between remote and local sessions
...
## <a name="logout-of-a-remote-session"></a>Logout of a remote session
