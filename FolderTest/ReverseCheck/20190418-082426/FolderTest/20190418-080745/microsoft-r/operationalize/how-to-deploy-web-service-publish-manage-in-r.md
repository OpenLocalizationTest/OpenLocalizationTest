...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: 1eb1e39cfb410602761ef67a5ef91d390548aa4c
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="how-to-publish-and-manage-r-web-services-in-machine-learning-server-with-mrsdeploy"></a>How to publish and manage R web services in Machine Learning Server with mrsdeploy
...
## <a name="permissions-for-managing-web-services"></a>Permissions for managing web services
...
## <a name="publish-and-update-web-services"></a>Publish and update web services
...
### <a name="publish-service"></a>Publish service
...
### <a name="supported-io-data-types"></a>Supported I/O data types
...
## <a name="standard-workflow-examples"></a>Standard workflow examples
...
### <a name="1-r-code-and-model-are-objects"></a>1. R code and model are objects
...
### <a name="2-r-code-as-object-and-rdata-as-file"></a>2. R code as object and RData as file 
...
### <a name="3-code-and-model-as-r-scripts"></a>3. Code and model as R scripts 
...
### <a name="4-code-as-script-and-model-as-a-rdata-file"></a>4. Code as script and model as a RData file
...
### <a name="5-r-code--model-as-objects-inputsoutputs-as-dataframes"></a>5. R code & model as objects, inputs/outputs as dataframes
...
## <a name="real-time-workflow-example"></a>Real-time workflow example
