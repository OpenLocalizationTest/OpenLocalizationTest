...
ms.topic: conceptual
ms.prod: mlserver
ms.openlocfilehash: c6b31d5611c40e9f7a4c99f10492195252697956
ms.sourcegitcommit: 9c76acdc-560c-45e5-982b-fef069067335
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 04/18/2019
---
# <a name="configure-machine-learning-server-93-to-operationalize-analytics-enterprise"></a>Configure Machine Learning Server 9.3 to operationalize analytics (Enterprise)
